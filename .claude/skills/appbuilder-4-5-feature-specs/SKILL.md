---
name: appbuilder-4-5-feature-specs
description: >
  Step 4.5 of the appbuilder pipeline — expands every must/should PRD
  ...
  ab-feature-author subagents in parallel, features split into batches,
...
### 4.5.2 — Spawn 3–5 `ab-feature-author` subagents (parallel, ONE message)
...
```
subagent_type: ab-feature-author
prompt: |
  ...
  PIPELINE POSITION: You are step 4.5 (feature specs) of the appbuilder
...
```
Skill(skill: "appbuilder-5-stack-research")
```
