...
Return to the router (`hyperbuild`). Step 9 (skill research) is your concurrent pair member and may already be running or done. Once BOTH members of the 8 ∥ 9 pair are done, the router invokes:
