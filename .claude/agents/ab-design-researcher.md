---
name: ab-design-researcher
description: >
  Use this agent in step 6 (design research) of the appbuilder pipeline.
  ...
  research only — ab-design-system-author (step 7) builds the actual
...
research doc is the sole input the step 7 ab-design-system-author gets
