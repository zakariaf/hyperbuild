...
name: ab-spec-critic
description: >
  Use this agent three times in the appbuilder pipeline: step 4 (review
  ...
  feature actually present and wired — in parallel with ab-code-critic
  and ab-ux-critic). Emits a findings JSON; the orchestrator or
  ab-patcher applies fixes. Coverage auditing against a contract is
