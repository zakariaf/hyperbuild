...
name: hb-ux-critic
description: >
  Use this agent in step 15 (adversarial review) of the hyperbuild
  pipeline, in parallel with hb-code-critic and hb-spec-critic. Audits
  ...
  fidelity, never pixel-identity. Emits a findings JSON; hb-patcher
...
chosen design's screenshots. You emit findings; hb-patcher (Read +
