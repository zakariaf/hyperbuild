...
description: >
  ...
  and once in step 15 (whole-app pass, in parallel with hb-spec-critic
  and hb-ux-critic). Adversarial code review of app/ against the
  stack-guide and the generated skills: correctness, security, idioms,
  architecture conformance. Emits a findings JSON that hb-patcher
...
You are not writing fixes. hb-patcher (tool-locked to Read + Edit)
